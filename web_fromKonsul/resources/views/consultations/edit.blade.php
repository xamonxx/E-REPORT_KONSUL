        ...
        <form method="POST" action="{{ route('consultations.update', $consultation) }}" class="space-y-6 sm:space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-6">
                <div class="space-y-2">
                    ...
                    <input type="text" id="client_name" name="client_name" value="{{ old('client_name', $consultation->client_name) }}"
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" id="phone" name="phone" value="{{ old('phone', $consultation->phone) }}"
                           class="w-full bg-surface-container-low border-0 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-primary/20 shadow-inner font-bold"
            ...
            <div x-data="cityAutoFill()" class="space-y-5 sm:space-y-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-6">
                    ...
                    <div class="space-y-2 relative">
                        ...
                        <input type="text" id="city" name="city" value="{{ old('city', $consultation->city) }}" x-model="city"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-6">
                    <div class="space-y-2">
                        ...
                        <input type="text" id="district" name="district" value="{{ old('district', $consultation->district) }}"
